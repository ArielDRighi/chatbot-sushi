...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(user_roles_enum_1.UserRole.CUSTOMER, user_roles_enum_1.UserRole.ADMIN),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return an order.' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'The ID of the order' }),
