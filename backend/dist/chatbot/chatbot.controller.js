...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Handle chatbot message' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Message handled successfully.' }),
    (0, swagger_1.ApiBody)({ schema: { example: { message: 'Quiero 2 sushi de salmón' } } }),
