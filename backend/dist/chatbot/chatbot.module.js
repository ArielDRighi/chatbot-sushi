...
exports.ChatbotModule = ChatbotModule = __decorate([
    (0, common_1.Module)({
        imports: [menu_module_1.MenuModule, orders_module_1.OrderModule],
        controllers: [chatbot_controller_1.ChatbotController],
        providers: [chatbot_service_1.ChatbotService, orders_service_1.OrderService, menu_service_1.MenuService],
    })
], ChatbotModule);
